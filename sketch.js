...
function sceneDraw() {
  ...
  scenes[3] = {
    text:
      "We snail people don't really use names \nmuch, but I'll try.\n\n[1] Snail people?\n\n[2] Wait, snails can talk?",
  ...
  scenes[19] = {
    text:
      "I wasn't interested in the same things\nthat other slugs were.\n\n[1] (Keep listening...)",
    image: assets.furrowed_normal,
    keys: ["1"],
    nextPages: [20],
    sound: song,
  ...
  scenes[20] = {
    text:
      "Wearing slug clothes, doing slug things!\nI hated that so much but...\n\n[1] (Keep listening...)",
    image: assets.furrowed_normal,
    keys: ["1"],
    nextPages: [21],
    sound: song,
  ...
  scenes[33] = {
    text:
      "I never necessarily wanted a shell...\nBut...\nPeople calling me a snail...\n\n[1] (Keep listening...)",
    image: assets.furrowed_normal,
    keys: ["1"],
    nextPages: [34],
    sound: song,
  ...
  scenes[41] = {
    text:
      "I think I would just feel singled out.\nAlmost as if they could tell, you know!\n\n[1] (Keep listening...)",
    image: assets.talking_normal,
    keys: ["1"],
    nextPages: [42],
    sound: song,
  ...
  scenes[42] = {
    text:
      "And, and sometimes when I look at\nmyself...\n\n[1] (Keep listening...)",
    image: assets.furrowed_normal,
    keys: ["1"],
    nextPages: [43],
    sound: song,
  ...
  scenes[53] = {
    text:
      "Awesome, lay it on me!\n\n(Press [1] after you submit your name,\nand make sure to click outside of the\ntext box before you do so!)",
    image: assets.smiling_normal,
    keys: ["1"],
    nextPages: [54],
    sound: song,
